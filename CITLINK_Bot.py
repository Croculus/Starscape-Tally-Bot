import json, Kill_Calculator, nextcord, datetime, os, pytz, psycopg2
from nextcord.ext import commands, tasks
from nextcord.ui import View, Button
import urllib.parse as urlparse

# this is the version I setup using heroku as my host

with open("Factions.json") as json_file:
...
def makeidentifier(string):
     ...
     return string
# configure channels
kill_channel_id = int(os.environ.get('kill_channel_id'))
ver_channel_id = int(os.environ.get('ver_channel_id'))
publish_channel_id = int(os.environ.get('publish_channel_id'))
mod_role_id= int(os.environ.get('mod_role_id'))
ping_role_id = int(os.environ.get('ping_role_id'))
